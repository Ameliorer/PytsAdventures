...
class LevelSelector:
    ...
    def __init__(self, nbLevels, screen) -> None:
        ...
        self.text_retour_y = (3*self.screen.get_height())/4 - self.text_retour_rect.height / 2
    ...
    def afficheLevelSelector(self):
        ...
        text_y = self.screen.get_height() / 4 - text_rect.height / 2     # on le met au milieu de l'écran
